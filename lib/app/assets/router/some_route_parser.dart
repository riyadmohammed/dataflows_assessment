...
class CustomRouteParser extends GoRouteInformationParser {
  ...
  Future<RouteMatchList> parseRouteInformationWithDependencies(
    ...
    late RouteInformation deeplinkRouteInformation = RouteInformation(
    ...
    initialMatches = configuration.findMatch(
      deeplinkRouteInformation.uri,
      extra: deeplinkRouteInformation.state,
    );
